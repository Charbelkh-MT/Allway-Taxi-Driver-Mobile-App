export const translations = {
  en: {
    ...
    forgotPinMsg:        'Please contact your dispatcher to reset your PIN. They can update it from the CRM dashboard.',
    ...
    enableFaceIdQ:       'Enable Face ID login?',
    enableFaceIdMsg:     'Sign in faster next time using Face ID instead of your PIN.',
    enableBiometricYes:  'Enable',
    biometricFailed:     'Fingerprint not recognised. Please use your PIN.',
    faceIdFailed:        'Face not recognised. Please use your PIN.',
    faceIdPrompt:        'Use Face ID to sign in',
  ...
  ar: {
    ...
    forgotPinMsg:        'يرجى التواصل مع المرسل لإعادة تعيين رمز PIN. يمكنه تحديثه من لوحة تحكم CRM.',
    ...
    enableFaceIdQ:       'تفعيل تسجيل الدخول بـ Face ID؟',
    enableFaceIdMsg:     'سجّل دخولك بسرعة في المرة القادمة باستخدام Face ID بدلاً من رمز PIN.',
    enableBiometricYes:  'تفعيل',
    biometricFailed:     'لم يتم التعرف على البصمة. يرجى استخدام رمز PIN.',
    faceIdFailed:        'لم يتم التعرف على الوجه. يرجى استخدام رمز PIN.',
    faceIdPrompt:        'استخدم Face ID لتسجيل الدخول',
    tryDemo:             '⚡  تجربة العرض',
